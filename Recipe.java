public class Recipe {
    ...
    public Recipe(int recipeId, String name, String description, String dateCreated,
                  int prepTime, int cookTime, String difficulty, int userId, 
                  String authorName, String region) {
    ...
    public String getDifficulty() { return difficulty != null ? difficulty : "Not specified"; }
